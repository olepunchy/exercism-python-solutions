...
def tag_special_ingredients(dish):
    ...
    special_ingredients = ingredients & SPECIAL_INGREDIENTS
...
def separate_appetizers(dishes, appetizers):
    ...
    set_difference = dishes_set.difference(appetizers_set)
